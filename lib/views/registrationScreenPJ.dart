...
class registrationScreenPJ extends StatefulWidget {
  const registrationScreenPJ({super.key});

  @override
  State<registrationScreenPJ> createState() => _registrationScreenPJState();
}

@override
class _registrationScreenPJState extends State<registrationScreenPJ> {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        primary: Color.fromARGB(255, 8, 46, 28)),
                  )
                ],
              ),
            ),
