...
class registrationScreenPF extends StatefulWidget {
  ...
  @override
  State<registrationScreenPF> createState() => _registrationScreenPFState();
}

@override
class _registrationScreenPFState extends State<registrationScreenPF> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => registrationScreenPJ()));
                    },
